...
include "header.php";
 ...
 ?>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb-wrap text-center">
                        <h2 class="breadcrumb-title">blog gallery</h2>
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">blog details gallery</li>
                            </ul>
                        </nav>
                    </div>
                </div>
    ...
    <div class="blog-main-wrapper pt-100 pb-100 pt-sm-60 pb-sm-30 pb-md-40">
        <div class="container">
            <div class="row">
                <!-- start blog main wrapper -->
                <div class="col-lg-9 order-lg-2">
                    <div class="blog-content-wrap mb-md-100">
                        <div class="single-blog-item mb-30 mb-sm-0">
                            <div class="blog-thumb">
                                <div class="blog-gallery-slider slick-arrow-style2">
                            ...
                            <div class="blog-content blog-main">
                                <h4>this is first post for xipblog</h4>
                                <div class="blog-meta">
                                    <a href="blog-details.html">by admin</a>
                                    <a href="blog-details.html">30, oct 2018</a>
                                ...
                                <div class="blog-social-sharing mt-20 mb-40">
                        ...
                        <!-- end blog main wrapper -->
                        <!-- start blog comment box -->
                        <div class="blog-comment-wrapper mb-sm-60">
                            <h3>leave a reply</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="coment-btn mt-20">
                                                <input class="check-btn sqr-btn" type="submit" name="submit" value="post comment">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-3 order-lg-1">
                    <div class="blog-sidebar-wrapper mb-md-60 mb-sm-0">
                        ...
                        <div class="blog-sidebar mb-30">
                            ...
                            <div class="recent-post mb-20">
                                ...
                                <div class="recent-post-des">
                                    <span><a href="blog-details.html">Arbor Swoon Camber</a></span>
                            ...
                            <div class="recent-post mb-20">
                                ...
                                <div class="recent-post-des">
                                    <span><a href="blog-details.html">raygun snowboard arbor</a></span>
                                    <span class="post-date">28.10.2018</span>
                                </div>
                            </div> <!-- end single popular item -->
                            <div class="recent-post mb-20">
                        ...
                        <div class="blog-sidebar mb-30">
                            ...
                            <ul class="blog-tags">
                                ...
                                <li><a href="#">raygun</a></li>
                                <li><a href="#">surf</a></li>
                                <li><a href="#">berzerke</a></li>
                                <li><a href="#">skateboard</a></li>
                                <li><a href="#">shoes</a></li>
                            </ul>
                        </div> <!-- single sidebar end -->
                        <div class="shop-sidebar mb-30 mb-sm-25">
                            <div class="advertising1">
                                <a href="shop-grid-left-sidebar.html">
                                    <img src="assets/img/banner/advertising-s1.jpg" alt="">
                                </a>
                            </div>    
                        </div> <!-- single sidebar end -->
                    </div>
